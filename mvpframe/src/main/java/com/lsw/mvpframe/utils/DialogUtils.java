...
//        }
    ...
    public void createProgressAndShow(String msg, Context m) {
        mProgress = new ProgressDialog(m);
        mProgress.getWindow().setWindowAnimations(R.style.popupAnimationAlpha);
...
//        toast = new Toast(MyApplication.getmContext());
//        View toastView = LayoutInflater.from(MyApplication.getmContext()).inflate(R.layout.toast_layout, null);
...
//            toastImage.setVisibility(View.VISIBLE);
//        }
//        toast.setGravity(Gravity.BOTTOM, 10, ImageUtils.dipToPX(MyApplication.getmContext(),55));
...
//    }
    ...
    public static void makeText(String msg, int lengthShort) {
        Toast.makeText(MyApplication.getInstance().getContext(),msg,lengthShort).show();

    }
    public static void makeText(String msg) {
        Toast.makeText(MyApplication.getInstance().getContext(),msg,Toast.LENGTH_SHORT).show();
