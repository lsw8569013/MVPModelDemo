package com.lsw.mvpframe.rxhttp.config;


import com.lsw.mvpframe.MyApplication;
import com.lsw.mvpframe.rxhttp.ViseHttp;
import com.lsw.mvpframe.rxhttp.core.ApiCookie;
import com.lsw.mvpframe.rxhttp.interceptor.GzipRequestInterceptor;
import com.lsw.mvpframe.rxhttp.interceptor.OfflineCacheInterceptor;
import com.lsw.mvpframe.rxhttp.interceptor.OnlineCacheInterceptor;
import com.lsw.mvpframe.rxhttp.mode.ApiHost;
...
public class HttpGlobalConfig {
    public static boolean canLog = MyApplication.isdebug;
    ...
    private boolean isHttpCache = false;//是否使用Http缓存
