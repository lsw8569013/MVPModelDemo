...
/**
 *
 * author: Created by lsw on 2018/5/30 11:17
 * description:
 *
 * 封装Glide实现图片的缓存优化加载
 *
...
//                        .thumbnail(0.5f)
     ...
     * @param uri
     */
    public void displayC(ImageView imageView, String imageVideoUrl, String uri,String qiniuUrl) {
        try {
    ...
    public static String getVideoThumbnails(String mediaUrl, int width){
//        String mediaUrl;
...
//        }
    ...
    public void displayCVideo(ImageView imageView, String imageVideoUrl, String smallUrl ) {
        try {
            DrawableRequestBuilder thumbnailBuilder;
            thumbnailBuilder = Glide.with(mContext)
                    .load(imageVideoUrl+ getVideoThumbnails(smallUrl, 50));
...
//    }
     ...
     * @param url 图片地址
     */
    public void loadNetImageUrl(ImageView imageView,String url,int drawableid) {
        with.load(url)
                .skipMemoryCache(false)
                .dontAnimate()
                .thumbnail(0.3f)
